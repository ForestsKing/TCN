...
class EXP:
    def __init__(self, his_len=96, pre_len=96, lr=0.001, batch_size=32, epochs=10, patience=3, verbose=True):
        ...
        self.modelpath = './checkpoint/tcn_model.pkl'
    ...
    def _get_model(self):
        ...
        self.model = TCN(pre_len=self.pre_len).to(self.device)
